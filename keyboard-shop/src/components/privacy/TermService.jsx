...
export default function TermService() {
  return (
    <div className="term-service">
      <Container className="container-term-service">
        <h1>Terms of service</h1>
        <div className="content-term-service">
          <div className="content-term-service content-overview">
            <h1>Overview</h1>
            <p>
              This website is operated by MechkeyStore. Throughout the site, the
              terms “we”, “us” and “our” refer to MechkeyStore. MechkeyStore
          ...
          <div className="content-term-service content-section4 content-section1">
            <h1>
              SECTION 1 - ONLINE STORE TERMS<h1></h1>
            </h1>
            <p>
          ...
          <div className="content-term-service content-section4 content-section2">
            <h1>
              SECTION 2 - GENERAL CONDITIONS<h1></h1>
            </h1>
            <p>
          ...
          <div className="content-term-service content-section4 content-section3">
            <h1>
              <h1></h1>
          ...
          <div className="content-term-service content-section4">
          ...
          <div className="content-term-service content-section5">
            ...
            <p>
              ...
              our Return Policy.<br></br> We have made every effort to display
              as accurately as possible the colors and images of our products
              that appear at the store. We cannot guarantee that your computer
              monitor's display of any color will be accurate.<br></br> We
              ...
              this site is void where prohibited.<br></br> We do not warrant
          ...
          <div className="content-term-service content-section6">
          ...
          <div className="content-term-service content-section7">
            ...
            <p>
              ...
              optional third-party tools.<br></br> Any use by you of optional
              ...
              third-party provider(s).<br></br> We may also, in the future,
          ...
          <div className="content-term-service content-section8">
            ...
            <p>
              ...
              services of third-parties.<br></br> We are not liable for any harm
          ...
          <div className="content-term-service content-section9">
            ...
            <p>
              ...
              or (3) to respond to any comments.<br></br> We may, but have no
              ...
              these Terms of Service.<br></br> You agree that your comments will
          ...
          <div className="content-term-service content-section10">
          ...
          <div className="content-term-service content-section11">
            ...
            <p>
              ...
              after you have submitted your order).<br></br> We undertake no
          ...
          <div className="content-term-service content-section12">
          ...
          <div className="content-term-service content-section13">
            <h1>
            ...
            <p>
              ...
              or cancel the service at any time, without notice to you.<br></br>{" "}
              ...
              non-infringement.<br></br> In no case shall ToanStore, our
          ...
          <div className="content-term-service content-section14">
            <h1>SECTION 14 - INDEMNIFICATION</h1>
            <p>
              You agree to indemnify, defend and hold harmless MechkeyStore and
          ...
          <div className="content-term-service content-section15">
          ...
          <div className="content-term-service content-section16">
            ...
            <p>
              ...
              agreement for all purposes.<br></br> These Terms of Service are
          ...
          <div className="content-term-service content-section17">
            <h1>SECTION 17 - ENTIRE AGREEMENT</h1>
            <p>
              The failure of us to exercise or enforce any right or provision of
              these Terms of Service shall not constitute a waiver of such right
              or provision.<br></br> These Terms of Service and any policies or
              ...
              limited to, any prior versions of the Terms of Service).<br></br>{" "}
              Any ambiguities in the interpretation of these Terms of Service
              shall not be construed against the drafting party.
            </p>
          </div>
          <div className="content-term-service content-section18">
          ...
          <div className="content-term-service content-section19">
          ...
          <div className="content-term-service content-section20">
            <h1>SECTION 20 - CONTACT INFORMATION</h1>
            <p>
            Questions about the Terms of Service should be sent to us at trantoan11011996@gmail.com.
            </p>
          </div>
        </div>
      </Container>
